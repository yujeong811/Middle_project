...
public class PickRoomVO {
	...
	public String toString() {
		return "PickRoomVO [prod_id=" + prod_id + ", prod_type=" + prod_type + ", prod_part=" + prod_part
				+ ", prod_add1=" + prod_add1 + ", prod_add2=" + prod_add2 + ", prod_name=" + prod_name + ", prod_des="
				+ prod_des + ", prod_per=" + prod_per + ", prod_date=" + prod_date + ", prod_price=" + prod_price
				+ ", host_id=" + host_id + ", accept=" + accept + ", img_link=" + img_link + "]";
	}
