...
public class MemberDaoImpl implements IMemberDao {
	private static MemberDaoImpl memDao; // 자신을 멤버로 선언해서 메모리에 올려놓음
	
	private MemberDaoImpl() { // 생성자
		
	}
	
	// 외부에서 멤버로 선언된 것을 가져올 수 있는 메소드 만들기
	public static MemberDaoImpl getInstance(){ // 이렇게 만들면 getInstance 메서드 외에는 MemberDaoImpl 객체를 생성 및 사용할 수 없음
