...
public class CaptchaImg {
	private static CaptchaImg captchaImg;
	
	private CaptchaImg() {}
	
	public static CaptchaImg getInstance() {
		if(captchaImg == null) captchaImg = new CaptchaImg();
		return captchaImg;
	}
	

	public String imgFileName(String key) {
		String clientId = "qkq5pNo6xeTcflC3qMb4"; //애플리케이션 클라이언트 아이디값";
        String clientSecret = "o30Ci_ADB6"; //애플리케이션 클라이언트 시크릿값";
    ...
    private static String getImage(InputStream is){
        ...
        File f = new File("D:\\D_Other\\captchaImg\\" + filename + ".jpg");
