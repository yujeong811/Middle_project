...
@WebServlet("/AnsSelect.do")
public class AnsSelect extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ansVo.setQna_id(qnaID);
		ansVo.setQna_cate(cate);
		
		QNA_ANSVO ansVo2 = service.SeeAns(ansVo);
		
		//System.out.println(ansVo2);
		
		Gson gson = new Gson();
		String result = gson.toJson(ansVo2);
